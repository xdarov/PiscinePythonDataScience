...
clients = ['andrew@gmail.com', 'jessica@gmail.com', 'ted@mosby.com',   #учетные записи электронной почты
           'john@snow.is', 'bill_gates@live.com', 'mark@facebook.com',
           'elon@paypal.com', 'jessica@gmail.com']
participants = ['walter@heisenberg.com', 'vasily@mail.ru', 'pinkman@yo.org', #участники последнего мероприятия
                'jessica@gmail.com', 'elon@paypal.com', 'pinkman@yo.org',
                'mr@robot.gov', 'eleven@yahoo.com']
recipients = ['andrew@gmail.com', 'jessica@gmail.com', 'john@snow.is']   # учетные записи клиентов которые просмотрели ваше последнее письмо
